...
export const COURSES: Record<string, Course> = {
  biology: {
    ...
    order: 1,
    quizRibbonImage: '/images/biology-quiz-ribbon.webp',
    reviewRibbonImage: '/images/biology-review-ribbon.webp',
    quizRibbonScale: 1,
    reviewRibbonScale: 1,
    studentsRibbonImage: '/images/biology-students-ribbon.webp',
    studentsRibbonScale: 1,
    dashboardRibbonImage: '/images/biology-dashboard-ribbon.webp',
  ...
  pathophysiology: {
    ...
    classes: ['A', 'B', 'C', 'D'],
    order: 3,
    quizRibbonImage: '/images/pathophysiology-quiz-ribbon.webp',
    reviewRibbonImage: '/images/pathophysiology-review-ribbon.webp',
    quizRibbonScale: 1,
    reviewRibbonScale: 1,
    studentsRibbonImage: '/images/pathophysiology-students-ribbon.webp',
    studentsRibbonScale: 1,
    dashboardRibbonImage: '/images/pathophysiology-dashboard-ribbon.webp',
    dashboardRibbonScale: 1,
  },
  microbiology: {
    id: 'microbiology',
    ...
    classes: ['A', 'B', 'C', 'D'],
    order: 2,
    quizRibbonImage: '/images/microbiology-quiz-ribbon.webp',
    reviewRibbonImage: '/images/microbiology-review-ribbon.webp',
    quizRibbonScale: 1,
    reviewRibbonScale: 1,
    studentsRibbonImage: '/images/microbiology-students-ribbon.webp',
    studentsRibbonScale: 1,
    dashboardRibbonImage: '/images/microbiology-dashboard-ribbon.webp',
    dashboardRibbonScale: 1,
  },
};
