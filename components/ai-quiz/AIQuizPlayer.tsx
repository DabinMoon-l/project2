    ...
    return createPortal(
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#F5F0E8]">
        ...
        >
          {/* 결과 아이콘 */}
          <div className="mb-6">
            <div className={`inline-flex items-center justify-center w-24 h-24 border-4 rounded-full ${
          ...
          {/* 폴더명 */}
          <div className="text-sm text-[#5C5C5C] mb-2">{folderName}</div>
          ...
          <button
            ...
            className="w-full py-4 font-bold text-lg border-2 border-[#1A1A1A] bg-[#1A1A1A] text-white shadow-[3px_3px_0px_#1A1A1A] active:shadow-none active:translate-x-[3px] active:translate-y-[3px] transition-all"
          >
            학습 완료
          </button>
        </motion.div>
          ...
          >
            ...
            <div className="p-4 border-2 border-[#1A1A1A] bg-white">
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center border-2 border-[#1A1A1A] bg-[#1A1A1A] text-white font-bold text-sm">
                  Q
                </span>
              ...
              {currentQuestion.choices.map((choice, idx) => {
                ...
                return (
                  <button
                    ...
                    disabled={isAnswered}
                    className={`w-full p-4 border-2 text-left transition-all ${buttonStyle}`}
                  >
                    <div className="flex items-start gap-3">
            ...
            {isMultipleAnswer && !isAnswered && (
              <button
                ...
                className={`w-full py-3 font-bold border-2 transition-all ${
            ...
            <AnimatePresence>
              {isAnswered && currentQuestion.explanation && (
                <motion.div
                  ...
                  className="p-4 border-2 border-[#1A1A1A] bg-[#EDEAE4]"
                >
