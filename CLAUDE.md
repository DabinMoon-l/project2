...
| 순서 | Phase | 작업 | 소요 예상 | 영향도 |
|------|-------|------|----------|--------|
| 1 | 1 | **반응형 세로/가로 완성** | 3~5일 | 사용자 체감 UX |
| 2 | 2 | Dynamic Import 도입 | 1~2일 | 번들 크기 40~60% 감소 |
| 3 | 2 | onSnapshot 구독 최적화 | 2~3일 | Firestore 비용 30~50% 절감 |
| 4 | 2 | 거대 파일 분할 (Top 3) | 3~5일 | 유지보수성, 빌드 속도 |
| 5 | 2 | 중복 코드 제거 | 2~3일 | 코드 품질 |
| 6 | 3 | Cloud Functions 최적화 | 2~3일 | 콜드 스타트, 비용 절감 |
| 7 | 3 | Firestore 쿼리 최적화 | 2~3일 | 읽기 비용 절감 |
| 8 | 4 | Vitest 단위 테스트 | 3~5일 | 핵심 로직 안정성 |
| 9 | 4 | Playwright E2E 테스트 | 5~7일 | 회귀 방지 |
| 10 | 4 | K6 부하 테스트 | 3~5일 | 500명 동시접속 검증 |
| 11 | 5 | 레이스 컨디션 + 보안 감사 | 3~5일 | 데이터 무결성, 보안 |
| 12 | 5 | 메모리 누수/에러 바운더리 | 2~3일 | 안정성 |
| 13 | 5 | 접근성 (a11y) | 2~3일 | 품질 |
